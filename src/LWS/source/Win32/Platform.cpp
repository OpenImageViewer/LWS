...
namespace
{
    ...
    int virtualKeyFromKeyCode(LWS::KeyCode key)
    {
        switch (key)
        {
            ...
            case LWS::KeyCode::Z:
                return 'Z';
            case LWS::KeyCode::Digit0:
                return '0';
            case LWS::KeyCode::Digit1:
                return '1';
            case LWS::KeyCode::Digit2:
                return '2';
            case LWS::KeyCode::Digit3:
                return '3';
            case LWS::KeyCode::Digit4:
                return '4';
            case LWS::KeyCode::Digit5:
                return '5';
            case LWS::KeyCode::Digit6:
                return '6';
            case LWS::KeyCode::Digit7:
                return '7';
            case LWS::KeyCode::Digit8:
                return '8';
            case LWS::KeyCode::Digit9:
                return '9';
            case LWS::KeyCode::F1:
                return VK_F1;
            case LWS::KeyCode::F2:
            ...
            case LWS::KeyCode::F9:
                return VK_F9;
            case LWS::KeyCode::F10:
                return VK_F10;
            case LWS::KeyCode::F11:
                return VK_F11;
            case LWS::KeyCode::F12:
                return VK_F12;
            ...
            case LWS::KeyCode::Down:
                return VK_DOWN;
            case LWS::KeyCode::Home:
                return VK_HOME;
            case LWS::KeyCode::End:
                return VK_END;
            case LWS::KeyCode::PageUp:
                return VK_PRIOR;
            case LWS::KeyCode::PageDown:
                return VK_NEXT;
            case LWS::KeyCode::Insert:
                return VK_INSERT;
            case LWS::KeyCode::Delete:
                return VK_DELETE;
            case LWS::KeyCode::Enter:
                return VK_RETURN;
            case LWS::KeyCode::Escape:
                return VK_ESCAPE;
            case LWS::KeyCode::Tab:
                return VK_TAB;
            case LWS::KeyCode::Backspace:
                return VK_BACK;
            case LWS::KeyCode::Space:
                return VK_SPACE;
            case LWS::KeyCode::Shift:
                return VK_SHIFT;
            case LWS::KeyCode::Control:
                return VK_CONTROL;
            case LWS::KeyCode::Alt:
                return VK_MENU;
            case LWS::KeyCode::Win:
                return VK_LWIN;
            case LWS::KeyCode::LShift:
                return VK_LSHIFT;
            case LWS::KeyCode::RShift:
                return VK_RSHIFT;
            case LWS::KeyCode::LControl:
                return VK_LCONTROL;
            case LWS::KeyCode::RControl:
                return VK_RCONTROL;
            case LWS::KeyCode::LAlt:
                return VK_LMENU;
            case LWS::KeyCode::RAlt:
                return VK_RMENU;
            case LWS::KeyCode::CapsLock:
                return VK_CAPITAL;
            case LWS::KeyCode::NumLock:
                return VK_NUMLOCK;
            case LWS::KeyCode::ScrollLock:
                return VK_SCROLL;
            case LWS::KeyCode::Numpad0:
                return VK_NUMPAD0;
            case LWS::KeyCode::Numpad1:
                return VK_NUMPAD1;
            case LWS::KeyCode::Numpad2:
                return VK_NUMPAD2;
            case LWS::KeyCode::Numpad3:
                return VK_NUMPAD3;
            case LWS::KeyCode::Numpad4:
                return VK_NUMPAD4;
            case LWS::KeyCode::Numpad5:
                return VK_NUMPAD5;
            case LWS::KeyCode::Numpad6:
                return VK_NUMPAD6;
            case LWS::KeyCode::Numpad7:
                return VK_NUMPAD7;
            case LWS::KeyCode::Numpad8:
                return VK_NUMPAD8;
            case LWS::KeyCode::Numpad9:
                return VK_NUMPAD9;
            case LWS::KeyCode::NumpadAdd:
                return VK_ADD;
            case LWS::KeyCode::NumpadSubtract:
                return VK_SUBTRACT;
            case LWS::KeyCode::NumpadMultiply:
                return VK_MULTIPLY;
            case LWS::KeyCode::NumpadDivide:
                return VK_DIVIDE;
            case LWS::KeyCode::NumpadDecimal:
                return VK_DECIMAL;
            case LWS::KeyCode::NumpadEnter:
                return VK_RETURN;
            case LWS::KeyCode::Comma:
                return VK_OEM_COMMA;
            case LWS::KeyCode::Period:
                return VK_OEM_PERIOD;
            case LWS::KeyCode::Slash:
                return VK_OEM_2;
            case LWS::KeyCode::Semicolon:
                return VK_OEM_1;
            case LWS::KeyCode::Quote:
                return VK_OEM_7;
            case LWS::KeyCode::LeftBracket:
                return VK_OEM_4;
            case LWS::KeyCode::RightBracket:
                return VK_OEM_6;
            case LWS::KeyCode::Backslash:
                return VK_OEM_5;
            case LWS::KeyCode::Minus:
                return VK_OEM_MINUS;
            case LWS::KeyCode::Equals:
                return VK_OEM_PLUS;
            case LWS::KeyCode::Tilde:
                return VK_OEM_3;
            case LWS::KeyCode::PrintScreen:
                return VK_SNAPSHOT;
            case LWS::KeyCode::Pause:
                return VK_PAUSE;
            case LWS::KeyCode::LButton:
                return VK_LBUTTON;
            case LWS::KeyCode::RButton:
                return VK_RBUTTON;
            case LWS::KeyCode::MButton:
                return VK_MBUTTON;
            default:
                return 0;
        }
    ...
    LWS::MonitorDesc monitorDescFromWin32(const LWS::internal::MonitorDesc& desc)
    {
        return {
            .handle = reinterpret_cast<uintptr_t>(desc.handle),
            ...
            .contentScale = {static_cast<double>(desc.dpiX) / 96.0, static_cast<double>(desc.dpiY) / 96.0},
            .pixelSize = {desc.monitorInfo.rcMonitor.right - desc.monitorInfo.rcMonitor.left,
                          desc.monitorInfo.rcMonitor.bottom - desc.monitorInfo.rcMonitor.top},
...
namespace LWS::internal::platform_backend
{
    ...
    bool supports(Feature feature)
    {
        switch (feature)
        {
            ...
            case Feature::FileDialog:
                return internal::isOleInitializedForCurrentThread();
    ...
    void refreshMonitors(internal::MonitorInfo& monitors)
    {
        monitors.refresh();
    }

    LWS::MonitorDesc getMonitorInfo(internal::MonitorInfo& monitors, uintptr_t monitorHandle, bool allowRefresh)
    {
        return monitorDescFromWin32(monitors.getMonitorInfo(reinterpret_cast<HMONITOR>(monitorHandle), allowRefresh));
    }

    LWS::MonitorDesc getPrimaryMonitor(internal::MonitorInfo& monitors, bool allowRefresh)
    {
        return monitorDescFromWin32(monitors.getPrimaryMonitor(allowRefresh));
    }

    Rect getBoundingMonitorArea(internal::MonitorInfo& monitors)
    {
        return rectFromWin32(monitors.getBoundingMonitorArea());
    }
}  // namespace LWS::internal::platform_backend
#endif
